...
if (fade_out_timer > 0) {
	...
	if (a1 <= 0) {
		...
		instance_destroy(oBeastNameTag);
		
		if(global.hasBone == true) {
			instance_create_layer(10,10,"Text",oText18BeastResponse);
		} else {
			instance_create_layer(10,10,"Text",oTextBeastNoBone);
		}
