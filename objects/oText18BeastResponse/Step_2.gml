...
if (fade_out_timer > 0) {
	...
	if (a1 <= 0) {
		...
		global.talkedToBeast = true;
		instance_create_layer(750,510,"Response",oBeastResponseWrong1);
		instance_create_layer(750,610,"Response",oBeastResponseWrong2);
		instance_create_layer(750,710,"Response",oBeastResponseCorrect);
		instance_destroy();
	}
}
