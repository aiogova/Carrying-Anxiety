...
if (fade_out_timer > 0) {
	...
	if (a1 <= 0) {
		...
		global.talkedToThiefAgain = true;
		instance_create_layer(750,510,"Response",oThiefAgainResponseWrong1);
		instance_create_layer(750,610,"Response",oThiefAgainResponseCorrect);
		instance_create_layer(750,710,"Response",oThiefAgainResponseWrong2);
		instance_destroy(oThiefNameTag);
		instance_destroy();
	}
}
