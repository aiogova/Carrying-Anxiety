...
if (fade_out_timer > 0) {
	...
	if (a1 <= 0) {
		...
		global.talkedToGuard2 = true;
		instance_create_layer(750,510,"Response",oGuardResponseWrong1);
		instance_create_layer(750,610,"Response",oGuardResponseCorrect);
		instance_create_layer(750,710,"Response",oGuardResponseWrong2);
		instance_destroy(oGuard2NameTag);
		instance_destroy();
	}
}
