...
{
	sprite_index = sGuardFlippedSelected;
	...
	if(mouse_check_button_pressed(mb_left) && global.text_currently_on_screen == false && !instance_exists(oResponse)) {
		instance_create_layer(10,10,"Text",oText14Guard03);
		instance_create_layer(150,470,"Text",oGuard3NameTag);
	}
	
} else {
	sprite_index = sGuardFlipped;
}
