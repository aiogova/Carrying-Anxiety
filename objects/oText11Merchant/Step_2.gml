...
if (fade_out_timer > 0) {
	...
	if (a1 <= 0) {
		...
		global.talkedToMerchant = true;
		instance_create_layer(750,510,"Response",oMerchantResponseCorrect);
		instance_create_layer(750,610,"Response",oMerchantResponseWrong1);
		instance_create_layer(750,710,"Response",oMerchantResponseWrong2);
		instance_destroy(oMerchantNameTag);
		instance_destroy();
	}
}
