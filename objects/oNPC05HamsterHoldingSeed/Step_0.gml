...
{
	sprite_index = sHamsterHoldingSeedSelected;
	...
	if(mouse_check_button_pressed(mb_left) && global.text_currently_on_screen == false && !instance_exists(oResponse)) {
		instance_create_layer(10,10,"Text",oText05HamsterHoldingSeed);
		instance_create_layer(150,470,"Text",oHamsterNameTag);
	}
	
} else {
	sprite_index = sHamsterHoldingSeed;
}

if(global.reenteredArea1fromArea2 == true) {
	instance_destroy();
}