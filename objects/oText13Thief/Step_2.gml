...
if (fade_out_timer > 0) {
	...
	if (a1 <= 0) {
		...
		global.talkedToThief = true;
		instance_create_layer(750,510,"Response",oThiefResponseWrong1);
		instance_create_layer(750,610,"Response",oThiefResponseWrong2);
		instance_create_layer(750,710,"Response",oThiefResponseCorrect);
