...
if (fade_out_timer > 0) {
	...
	if (a1 <= 0) {
		...
		global.talkedToHamsterHoldingUltimateSword = true;
		instance_destroy(oHamsterNameTag);
		instance_create_layer(10,10,"Text",oText19HamsterHoldingUltimateSwordResponse);
		instance_destroy();
	}
}
