...
if (fade_out_timer > 0) {
	...
	if (a1 <= 0) {
		...
		global.talkedToVillager = true;
		instance_create_layer(750,510,"Response",oVillagerResponseCorrect);
		instance_create_layer(750,610,"Response",oVillagerResponseWrong1);
		instance_create_layer(750,710,"Response",oVillagerResponseWrong2);
		instance_destroy(oVillagerNameTag);
		instance_destroy();
	}
}
